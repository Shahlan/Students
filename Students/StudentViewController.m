...
- (void)viewDidLoad
{
    ...
    studentsData = [[NSMutableArray alloc] initWithObjects:@"Ahmad", @"Ali", @"Siti", @"Nabila", @"Azri", @"Hassan", @"Mohd. Razi", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [studentsData objectAtIndex:indexPath.row];
